...
const WhatsAppFloatIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-9 h-9 fill-current" xmlns="http://www.w3.org/2000/svg">
...
function App() {
  ...
  const handleFloatingClick = () => {
    if (window.fbq) {
      window.fbq('track', 'Contact', { 
        content_name: 'Botão Flutuante Geral',
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* Sticky Floating WhatsApp Button - Round Format, Visible on All Devices */}
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center bg-[#25D366] text-white w-16 h-16 rounded-full shadow-2xl hover:bg-[#128C7E] transition-all duration-300 transform hover:scale-110 border-4 border-white animate-pulse"
